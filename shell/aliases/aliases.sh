# shell/aliases/aliases.sh — shared shell aliases for bash AND zsh
#
# Single source of truth: alias syntax is identical in bash and zsh.
# Sourced by Dotfiles/shell/zsh/zshrc (~/.zshrc) and Dotfiles/shell/bashrc (~/.bashrc).
...
alias szsh='source "$DOTFILES/shell/zsh/zshrc"'
